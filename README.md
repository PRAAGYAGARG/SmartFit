...
The project demonstrates real world backend system design, including API Gateway, service discovery, event driven communication, centralized configuration, and secure authentication.
